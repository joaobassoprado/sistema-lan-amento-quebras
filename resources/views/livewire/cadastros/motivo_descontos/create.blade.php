...
$save = function () {
    ...
    try {
        ...
        return redirect(route('motivo_descontos.index'));
    } catch (Exception $e) {
    ...
    <div>
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="flex flex-col gap-2 bg-white mt-2 p-4 shadow rounded">
                <x-input label="Motivo:" wire:model="justificativa" icon="o-pencil" placeholder="Descreva o motivo aqui" />
            </div>
